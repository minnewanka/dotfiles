...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-ts-autotag', 'leap.nvim', 'nvim-hlslens', 'vim-rhubarb', 'nvim-cmp', 'vim-fugitive', 'nvim-bqf', 'Navigator.nvim', 'kommentary', 'tabby.nvim', 'marks.nvim', 'vim-unimpaired', 'lspsaga.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
