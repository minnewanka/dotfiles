...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "cmp-path", "nvim-autopairs" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-unimpaired', 'nvim-hlslens', 'vim-surround', 'vim-fugitive', 'nvim-bqf', 'kommentary', 'marks.nvim', 'lspsaga.nvim', 'nvim-cmp', 'Navigator.nvim', 'clever-f.vim', 'leap.nvim', 'nvim-ts-autotag', 'FixCursorHold.nvim', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
