...
local no_errors, error_msg = pcall(function()
	...
	local package_path_str =
		"/Users/philippe/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/Users/philippe/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/Users/philippe/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/Users/philippe/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
	...
	_G.packer_plugins = {
		...
		["cmp-buffer"] = {
			after_files = {
				"/Users/philippe/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua",
			},
			load_after = {
				["nvim-cmp"] = true,
			},
		...
		["cmp-nvim-lsp"] = {
			loaded = true,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp",
			url = "https://github.com/hrsh7th/cmp-nvim-lsp",
		},
		["cmp-nvim-lua"] = {
			after_files = {
				"/Users/philippe/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua",
			},
			load_after = {
				["nvim-cmp"] = true,
			},
		...
		["cmp-path"] = {
			after_files = {
				"/Users/philippe/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua",
			},
			load_after = {
				["nvim-cmp"] = true,
			},
		...
		cmp_luasnip = {
			after_files = {
				"/Users/philippe/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua",
			},
			load_after = {
				LuaSnip = true,
			},
		...
		["fidget.nvim"] = {
			...
			loaded = true,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/fidget.nvim",
			url = "https://github.com/j-hui/fidget.nvim",
		},
		["flit.nvim"] = {
			config = {
				"\27LJ\2\nD\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\1\14multiline\1\nsetup\tflit\frequire\0",
			},
			load_after = {
				["leap.nvim"] = true,
			},
			loaded = false,
			needs_bufread = false,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/opt/flit.nvim",
		...
		["lazygit.nvim"] = {
			...
			needs_bufread = true,
			only_cond = false,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/opt/lazygit.nvim",
		...
		["leap.nvim"] = {
			...
			needs_bufread = false,
			only_cond = false,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/opt/leap.nvim",
		...
		["nvim-cmp"] = {
			after = { "LuaSnip", "cmp-buffer", "cmp-nvim-lua", "cmp-path" },
		...
		["nvim-lspconfig"] = {
			config = {
				"\27LJ\2\nA\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\1K\0\1\0\15lsp/server\15lsp/config\frequire\0",
			},
			loaded = true,
		...
		["prettier.nvim"] = {
			...
			loaded = true,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/prettier.nvim",
		...
		["tabby.nvim"] = {
			...
			needs_bufread = false,
			only_cond = false,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/opt/tabby.nvim",
		...
		["trouble.nvim"] = {
			...
			needs_bufread = false,
			only_cond = false,
			path = "/Users/philippe/.local/share/nvim/site/pack/packer/opt/trouble.nvim",
	...
	pcall(
		vim.cmd,
		[[command -nargs=* -range -bang -complete=file LazyGit lua require("packer.load")({'lazygit.nvim'}, { cmd = "LazyGit", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
	)
	pcall(
		vim.cmd,
	...
	pcall(
		vim.cmd,
		[[command -nargs=* -range -bang -complete=file TSHighlightCapturesUnderCursor lua require("packer.load")({'playground'}, { cmd = "TSHighlightCapturesUnderCursor", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
	)
	pcall(
		vim.cmd,
	...
	pcall(
		vim.cmd,
		[[command -nargs=* -range -bang -complete=file Glog lua require("packer.load")({'vim-fugitive'}, { cmd = "Glog", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
	)
	pcall(
		vim.cmd,
		[[command -nargs=* -range -bang -complete=file Gdiffsplit lua require("packer.load")({'vim-fugitive'}, { cmd = "Gdiffsplit", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
	)
	pcall(
		vim.cmd,
		[[command -nargs=* -range -bang -complete=file GBlame lua require("packer.load")({'vim-fugitive'}, { cmd = "GBlame", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
	)
	pcall(
		vim.cmd,
	...
	vim.cmd([[au BufRead * ++once lua require("packer.load")({'tabby.nvim', 'lspsaga.nvim', 'nvim-ts-autotag', 'indent-blankline.nvim', 'gitsigns.nvim', 'kommentary', 'nvim-hlslens', 'vim-unimpaired', 'vim-rhubarb', 'vim-fugitive', 'nvim-bqf', 'nvim-cmp', 'marks.nvim', 'Navigator.nvim', 'leap.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]])
