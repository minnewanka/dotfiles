...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-lspconfig", "LuaSnip", "cmp-nvim-lsp", "cmp-path", "cmp-buffer", "cmp-nvim-lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'gitsigns.nvim', 'tabby.nvim', 'nvim-ts-autotag', 'leap.nvim', 'kommentary', 'marks.nvim', 'Navigator.nvim', 'lspsaga.nvim', 'nvim-cmp', 'vim-unimpaired', 'indent-blankline.nvim', 'vim-rhubarb', 'nvim-bqf', 'vim-fugitive'}, { event = "BufRead *" }, _G.packer_plugins)]]
