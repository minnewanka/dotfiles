...
_G.packer_plugins = {
  ...
  ["hydra.nvim"] = {
    config = { "\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23plugins.hydras.tab\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-nvim-lsp", "cmp-nvim-lua" },
...
try_loadstring("\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23plugins.hydras.tab\frequire\0", "config", "hydra.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'clever-f.vim', 'marks.nvim', 'Navigator.nvim', 'lspsaga.nvim', 'FixCursorHold.nvim', 'leap.nvim', 'indent-blankline.nvim', 'nvim-cmp', 'kommentary', 'nvim-hlslens', 'nvim-ts-autotag', 'vim-fugitive', 'vim-unimpaired', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
