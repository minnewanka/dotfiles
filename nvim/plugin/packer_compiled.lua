...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "nvim-autopairs", "cmp-buffer", "LuaSnip" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'leap.nvim', 'FixCursorHold.nvim', 'indent-blankline.nvim', 'nvim-hlslens', 'nvim-cmp', 'vim-unimpaired', 'nvim-bqf', 'Navigator.nvim', 'nvim-ts-autotag', 'vim-fugitive', 'marks.nvim', 'clever-f.vim', 'lspsaga.nvim', 'kommentary'}, { event = "BufRead *" }, _G.packer_plugins)]]
