...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "nvim-autopairs", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-unimpaired', 'marks.nvim', 'nvim-cmp', 'leap.nvim', 'nvim-ts-autotag', 'clever-f.vim', 'Navigator.nvim', 'indent-blankline.nvim', 'FixCursorHold.nvim', 'vim-fugitive', 'kommentary', 'nvim-hlslens', 'lspsaga.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
