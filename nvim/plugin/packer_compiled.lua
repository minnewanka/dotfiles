...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-lspconfig", "LuaSnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-buffer", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-autotag', 'marks.nvim', 'Navigator.nvim', 'tabby.nvim', 'lspsaga.nvim', 'indent-blankline.nvim', 'leap.nvim', 'vim-fugitive', 'gitsigns.nvim', 'vim-unimpaired', 'nvim-cmp', 'nvim-hlslens', 'nvim-bqf', 'vim-rhubarb', 'kommentary'}, { event = "BufRead *" }, _G.packer_plugins)]]
