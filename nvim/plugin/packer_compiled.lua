...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "LuaSnip", "nvim-autopairs", "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-fugitive', 'nvim-cmp', 'nvim-bqf', 'marks.nvim', 'lspsaga.nvim', 'leap.nvim', 'nvim-ts-autotag', 'kommentary', 'indent-blankline.nvim', 'Navigator.nvim', 'clever-f.vim', 'vim-unimpaired', 'nvim-hlslens', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
