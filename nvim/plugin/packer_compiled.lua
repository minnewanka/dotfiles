...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-nvim-lua", "nvim-lspconfig", "LuaSnip", "cmp-nvim-lsp" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-ts-autotag', 'kommentary', 'nvim-hlslens', 'vim-unimpaired', 'Navigator.nvim', 'vim-fugitive', 'nvim-bqf', 'leap.nvim', 'gitsigns.nvim', 'marks.nvim', 'lspsaga.nvim', 'vim-rhubarb', 'tabby.nvim', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
