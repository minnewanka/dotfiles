...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "LuaSnip", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp-cmdline" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-fugitive', 'lspsaga.nvim', 'leap.nvim', 'Navigator.nvim', 'indent-blankline.nvim', 'FixCursorHold.nvim', 'nvim-hlslens', 'nvim-bqf', 'marks.nvim', 'nvim-cmp', 'kommentary', 'vim-unimpaired', 'clever-f.vim', 'nvim-ts-autotag'}, { event = "BufRead *" }, _G.packer_plugins)]]
