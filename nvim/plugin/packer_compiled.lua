...
_G.packer_plugins = {
  ...
  ["nvim-hlslens"] = {
    ...
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/nvim-hlslens"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-signature'}, { event = "BufRead *" }, _G.packer_plugins)]]
