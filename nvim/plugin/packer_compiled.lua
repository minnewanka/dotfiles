...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "LuaSnip", "nvim-autopairs", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'gitsigns.nvim', 'Comment.nvim', 'nvim-cmp', 'lightspeed.nvim', 'Navigator.nvim', 'nvim-ts-autotag', 'vim-fugitive', 'vim-surround', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
