...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline", "nvim-autopairs" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-cmp', 'nvim-hlslens', 'nvim-bqf', 'Navigator.nvim', 'nvim-ts-autotag', 'FixCursorHold.nvim', 'vim-unimpaired', 'marks.nvim', 'lspsaga.nvim', 'vim-fugitive', 'leap.nvim', 'clever-f.vim', 'kommentary', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
