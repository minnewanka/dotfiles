...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "nvim-lspconfig", "LuaSnip", "cmp-path", "cmp-nvim-lua", "cmp-buffer" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'marks.nvim', 'gitsigns.nvim', 'lspsaga.nvim', 'kommentary', 'leap.nvim', 'nvim-ts-autotag', 'Navigator.nvim', 'vim-fugitive', 'nvim-cmp', 'nvim-hlslens', 'tabby.nvim', 'vim-unimpaired', 'vim-rhubarb', 'indent-blankline.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
