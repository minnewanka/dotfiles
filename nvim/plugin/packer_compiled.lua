...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "cmp-cmdline", "nvim-autopairs", "LuaSnip" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'gitsigns.nvim', 'nvim-bqf', 'marks.nvim', 'vim-surround', 'Navigator.nvim', 'kommentary', 'FixCursorHold.nvim', 'leap.nvim', 'vim-unimpaired', 'nvim-ts-autotag', 'nvim-cmp', 'indent-blankline.nvim', 'vim-fugitive', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
