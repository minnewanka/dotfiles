...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lua", "nvim-autopairs", "cmp-nvim-lsp", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Navigator.nvim', 'kommentary', 'leap.nvim', 'FixCursorHold.nvim', 'marks.nvim', 'indent-blankline.nvim', 'nvim-cmp', 'vim-unimpaired', 'nvim-hlslens', 'vim-fugitive', 'nvim-ts-autotag', 'lspsaga.nvim', 'clever-f.vim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
