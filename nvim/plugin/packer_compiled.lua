...
_G.packer_plugins = {
  ...
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim"
  },
  kommentary = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/kommentary"
  },
  ["lightspeed.nvim"] = {
    loaded = true,
  ...
  ["nvim-compe"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-spectre"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/nvim-spectre"
  },
  ["nvim-toggleterm.lua"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/nvim-toggleterm.lua"
  },
  ["nvim-tree.lua"] = {
    loaded = true,
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag"
  },
  ["nvim-ts-rainbow"] = {
    loaded = true,
  ...
  sonokai = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/sonokai"
  },
  ...
  undotree = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/undotree"
  },
  ["vim-fugitive"] = {
    loaded = true,
  ...
  ["vim-unimpaired"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/vim-unimpaired"
  },
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/vim-vsnip"
  },
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/zen-mode.nvim"
  }
}
