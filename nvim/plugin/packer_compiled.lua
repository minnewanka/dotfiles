...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-lspconfig", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp", "LuaSnip", "cmp-path" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'vim-unimpaired', 'leap.nvim', 'vim-fugitive', 'marks.nvim', 'nvim-ts-autotag', 'lspsaga.nvim', 'vim-rhubarb', 'gitsigns.nvim', 'nvim-bqf', 'Navigator.nvim', 'indent-blankline.nvim', 'kommentary', 'nvim-cmp', 'tabby.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
