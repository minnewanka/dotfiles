...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "nvim-autopairs", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-nvim-lsp", "cmp-nvim-lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'leap.nvim', 'kommentary', 'clever-f.vim', 'vim-unimpaired', 'nvim-hlslens', 'Navigator.nvim', 'FixCursorHold.nvim', 'nvim-cmp', 'nvim-bqf', 'indent-blankline.nvim', 'vim-fugitive', 'nvim-ts-autotag', 'marks.nvim', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
