...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "LuaSnip", "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "cmp-nvim-lua", "cmp-cmdline" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'marks.nvim', 'lspsaga.nvim', 'FixCursorHold.nvim', 'leap.nvim', 'vim-unimpaired', 'Navigator.nvim', 'vim-fugitive', 'nvim-hlslens', 'kommentary', 'nvim-ts-autotag', 'nvim-bqf', 'nvim-cmp', 'indent-blankline.nvim', 'clever-f.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
