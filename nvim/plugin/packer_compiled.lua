...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "nvim-autopairs", "cmp-path", "cmp-cmdline", "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'indent-blankline.nvim', 'kommentary', 'Navigator.nvim', 'vim-unimpaired', 'nvim-hlslens', 'vim-fugitive', 'nvim-bqf', 'nvim-ts-autotag', 'nvim-cmp', 'marks.nvim', 'leap.nvim', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
