...
_G.packer_plugins = {
  ...
  ["hydra.nvim"] = {
    config = { "\27LJ\2\nQ\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\1K\0\1\0\23plugins.hydras.tab\23plugins.hydras.git\frequire\0" },
    loaded = true,
    path = "/Users/philippe/.local/share/nvim/site/pack/packer/start/hydra.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-buffer", "cmp-nvim-lsp", "cmp-cmdline", "nvim-autopairs", "cmp-nvim-lua", "cmp-path" },
...
try_loadstring("\27LJ\2\nQ\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\1K\0\1\0\23plugins.hydras.tab\23plugins.hydras.git\frequire\0", "config", "hydra.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-cmp', 'marks.nvim', 'clever-f.vim', 'Navigator.nvim', 'leap.nvim', 'vim-unimpaired', 'FixCursorHold.nvim', 'indent-blankline.nvim', 'kommentary', 'vim-fugitive', 'nvim-ts-autotag', 'nvim-hlslens', 'nvim-bqf', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
