...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-lspconfig", "cmp-buffer", "cmp-nvim-lua", "LuaSnip", "cmp-path", "cmp-nvim-lsp" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'tabby.nvim', 'kommentary', 'gitsigns.nvim', 'Navigator.nvim', 'leap.nvim', 'nvim-hlslens', 'vim-unimpaired', 'nvim-ts-autotag', 'vim-rhubarb', 'nvim-cmp', 'nvim-bqf', 'lspsaga.nvim', 'marks.nvim', 'vim-fugitive', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
