...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-cmdline", "cmp-nvim-lua", "cmp-buffer", "cmp-nvim-lsp" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'vim-unimpaired', 'vim-surround', 'Navigator.nvim', 'vim-fugitive', 'FixCursorHold.nvim', 'leap.nvim', 'nvim-cmp', 'indent-blankline.nvim', 'marks.nvim', 'gitsigns.nvim', 'kommentary', 'nvim-hlslens', 'nvim-ts-autotag', 'lspsaga.nvim', 'clever-f.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lazygit.nvim', 'copilot.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
