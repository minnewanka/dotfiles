...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspkind-nvim', 'nvim-bqf', 'vim-commentary', 'nvim-treesitter', 'nvim-hlslens', 'vim-signature', 'Navigator.nvim', 'vim-surround', 'gitsigns.nvim', 'lightspeed.nvim', 'nvim-ts-autotag'}, { event = "BufRead *" }, _G.packer_plugins)]]
